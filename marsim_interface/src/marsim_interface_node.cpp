...
Interface::Interface() {
  pub  = nh.advertise<quadrotor_msgs::PositionCommand>("/planning/pos_cmd_1", 10);
  pub2 = nh.advertise<quadrotor_msgs::PositionCommand>("/planning/pos_cmd_2", 10);
  sub  = nh.subscribe<geometry_msgs::PoseStamped>("/quadrotor_1_pos_cmd", 10,
                                                 &Interface::messageCallback, this);
  /// move_base_simple/goal
  sub2 = nh.subscribe<geometry_msgs::PoseStamped>("/quadrotor_2_pos_cmd", 10,
                                                  &Interface::messageCallback2, this);
